...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container">
        <h1>Edit Product Specifications for {{ $product->productname }}</h1>

        <form action="{{ route('product-specifications.update', $product->id) }}" method="POST">
            @csrf
            @method('PUT')

            <div class="form-group">
                <label for="brand">Brand</label>
                <input type="text" name="brand" class="form-control" id="brand" value="{{ old('brand', $specifications->brand) }}">
            </div>

            <div class="form-group">
                <label for="model">Model</label>
                <input type="text" name="model" class="form-control" id="model" value="{{ old('model', $specifications->model) }}">
            </div>

            <div class="form-group">
                <label for="display">Display</label>
                <input type="text" name="display" class="form-control" id="display" value="{{ old('display', $specifications->display) }}">
            </div>

            <div class="form-group">
                <label for="processor">Processor</label>
                <input type="text" name="processor" class="form-control" id="processor" value="{{ old('processor', $specifications->processor) }}">
            </div>

            <div class="form-group">
                <label for="ram">RAM</label>
                <input type="text" name="ram" class="form-control" id="ram" value="{{ old('ram', $specifications->ram) }}">
            </div>

            <div class="form-group">
                <label for="storage">Storage</label>
                <input type="text" name="storage" class="form-control" id="storage" value="{{ old('storage', $specifications->storage) }}">
            </div>

            <div class="form-group">
                <label for="battery">Battery</label>
                <input type="text" name="battery" class="form-control" id="battery" value="{{ old('battery', $specifications->battery) }}">
            </div>

            <div class="form-group">
                <label for="os">Operating System</label>
                <input type="text" name="os" class="form-control" id="os" value="{{ old('os', $specifications->os) }}">
            </div>

            <div class="form-group">
                <label for="camera">Camera</label>
                <input type="text" name="camera" class="form-control" id="camera" value="{{ old('camera', $specifications->camera) }}">
            </div>

            <div class="form-group">
                <label for="connectivity">Connectivity</label>
                <input type="text" name="connectivity" class="form-control" id="connectivity" value="{{ old('connectivity', $specifications->connectivity) }}">
            </div>

            <div class="form-group">
                <label for="weight">Weight</label>
                <input type="text" name="weight" class="form-control" id="weight" value="{{ old('weight', $specifications->weight) }}">
            </div>

            <div class="form-group">
                <label for="dimensions">Dimensions</label>
                <input type="text" name="dimensions" class="form-control" id="dimensions" value="{{ old('dimensions', $specifications->dimensions) }}">
            </div>

            <div class="form-group">
                <label for="warranty">Warranty</label>
                <input type="text" name="warranty" class="form-control" id="warranty" value="{{ old('warranty', $specifications->warranty) }}">
            </div>

            <div class="form-group">
                <label for="included_items">Included Items</label>
                <textarea name="included_items" class="form-control" id="included_items">{{ old('included_items', $specifications->included_items) }}</textarea>
            </div>
