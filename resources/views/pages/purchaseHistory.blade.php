...
<header class="page-header">
    <div class="container">
        <div class="row align-items-center p-4">
            <div class="col-md-8">
                <h4 class="page-title text-black">Your Purchase History</h4>
                <p class="page-subtitle text-black">Review your past orders and track current shipments</p>
            </div>
            <div class="col-md-4 text-md-end text-black">
                <span class="">
...
<div class="">
            ...
            <div class="order-card">
                        ...
                        <div class="order-summary-card h-100">
                            ...
                            <div class="mt-4 pt-3 border-top">
                                <h6 class="detail-title"
                                    ...
                                    <span>Delivery Status</span> <i class="fas fa-chevron-down fs-6 mx-1"></i>
                                </h6>
                ...
                <div class="collapse order-details-collapse" id="orderDetails-{{ $order->id }}">
                    <div class="row">
                        ...
                        <!-- Billing Address -->
                        <div class="col-md-6 detail-section mx-md-0 mx-5">
                            <h6 class="detail-title">
    ...
    <!-- Pagination links -->
    <div class="mt-4 text-dark mx-3">
        {{ $previous_orders->links('pagination::bootstrap-5') }}
    </div>

</div>

 @include('component.PurchaseFooter')
