        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-black">All Customers</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th style="background-color: #232323" class="text-white ">User ID</th>
                                    <th style="background-color: #232323" class="text-white ">Name</th>
                                    <th style="background-color: #232323" class="text-white ">Email</th>
                                    <th style="background-color: #232323" class="text-white ">Role</th>
                                    <th style="background-color: #232323" class="text-white ">Created_on</th>
                                    <th style="background-color: #232323" class="text-white ">Last_updated</th>
                                    <th style="background-color: #232323" class="text-white ">Action</th>
                                </tr>
                            </thead>
                            <tbody>
