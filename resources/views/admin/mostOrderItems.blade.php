                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th style="background-color: #232323" class="text-white ">Product Image</th>
                                    ...
                                    <th style="background-color: #232323" class="text-white ">Stock_Quantity</th>
                                    <th style="background-color: #232323" class="text-white ">Price_(per_unit)</th>
                            ...
                            <tbody>
                                @foreach($most_order_items as $order_items)
                                <tr class="m-auto">
                                    <td><img class="w-50 h-50" src="{{ Storage::url($order_items->product->image) }}" alt=""></td>
                                    <td>{{ $order_items->product->productname }}</td>
                                    <td class="short-text">{{ $order_items->product->productdescription }}</td>
                                    <td class="text-center">{{ $order_items->product->stockquantity }}</td>
                                    <td class="text-center">Rs.{{ $order_items->product->totalprice }}</td>
                                    <td class="text-center">%{{ $order_items->product->discount }}</td>
                                    <td>{{ $order_items->product->category }}</td>
                                    <td>{{ $order_items->product->size }}</td>
                                    <td>{{ $order_items->product->status }}</td>
                                    <td>
