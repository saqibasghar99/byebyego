        ...
        <form action="{{route('add-product')}}" method="POST" enctype="multipart/form-data">
          @csrf
            ...
            <div class='d-flex flex-row'>
              <div class="form-group">
                  <label for="preview-image1">Preview_01</label>
                  <input type="file" id="preview_image1" name="preview_image1">
              </div>
              <div class="form-group">
                  <label for="preview-image2">Preview_02</label>
                  <input type="file" id="preview_image2" name="preview_image2">
              </div>
              <div class="form-group">
                  <label for="preview-image3">Preview_03</label>
                  <input type="file" id="preview_image3" name="preview_image3">
              </div>
            </div>
            ...
            <button type="submit" class="button" style="background-color: #232323;">Submit Product</button>
        </form>
    </div>
