        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-black">Products Profit</h6>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-hover" border="1" cellpadding="8" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background-color: #232323" class="text-white ">Product</th>
                                    <th style="background-color: #232323" class="text-white ">Quantity</th>
                                    <th style="background-color: #232323" class="text-white ">Total Price</th>
                                    <th style="background-color: #232323" class="text-white ">Cost</th>
                                    <th style="background-color: #232323" class="text-white ">%Tax</th>
                                    <th style="background-color: #232323" class="text-white ">%Dsicount</th>
                                    <th style="background-color: #232323" class="text-white ">Shipping</th>
                                    <th style="background-color: #232323" class="text-white ">Profit</th>
                            ...
                            <tbody>
                              @foreach($profits as $data)
                                <tr>
                                    <td><img height="35px" width="40px"  src="{{ Storage::url($data['productImage']) }}" alt=""></td>
                                    <td>{{ $data['product'] }}</td>
                                    <td>{{ $data['quantity'] }}</td>
                                ...
                                @endforeach
                                <tr>
                                  <td align="right"><strong>Total Profit:</strong></td>
                                  <td><strong>Rs. {{ $totalProfit }}</strong></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
