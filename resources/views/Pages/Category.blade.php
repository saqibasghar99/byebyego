...
<body>
    ...
    <section class="watches-hero animate__animated animate__fadeIn">
        ...
        <div class="container">
            ...
            <p class="category-line">Discover exclusive collections that spark joy and elevate your style — shop now and
                            ...
                            <div class="product-card shadow-sm">
                                ...
                                <div class="product-image-container">
                                    @if ($product->discount > 0)
                                        <span class="product-badge position-absolute">-{{ $product->discount }}%
                                            OFF</span>
                                    @endif
                                    ...
                                    <div class="product-price d-flex flex-md-row flex-column align-items-start">
                                        @if ($product->discount > 0)
                                            @php
                                                $discountprice =
                                                    $product->totalprice -
                                                    ($product->totalprice * $product->discount) / 100;
                                            @endphp
